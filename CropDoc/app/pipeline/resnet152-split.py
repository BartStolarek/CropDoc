...
class Pipeline():
    def __init__(self, config, dataset=None):
        ...
        self.scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(
            self.optimizer,
            mode='min',
            factor=self.model_config['training']['lr_scheduler']['ReduceLROnPlateau']['factor'],
            patience=self.model_config['training']['lr_scheduler']['ReduceLROnPlateau']['patience'],
            threshold=self.model_config['training']['lr_scheduler']['ReduceLROnPlateau']['threshold'],
        )
